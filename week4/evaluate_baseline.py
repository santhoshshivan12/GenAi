...
def main():
    ...
    print("======================================================================")
    print(" PHASE A: BASELINE DENSE RETRIEVAL EVALUATION (Top-3)")
    print("======================================================================")
    ...
    for q_item in golden_set:
        ...
        top_chunks = svc.retriever.search(question, top_k=3)
    ...
    baseline_out = WEEK4_DIR / "baseline_results.json"
    baseline_out.write_text(json.dumps(summary, indent=2), encoding="utf-8")

    print("\n----------------------------------------------------------------------")
    print(f" Baseline Hit@3 Score : {hits} / {len(golden_set)} ({hit_at_3_rate:.2f}%)")
    print(f" Baseline p50 Latency : {p50_latency:.2f} ms")
    print(f" Saved raw results to : {baseline_out}")
    print("----------------------------------------------------------------------\n")
